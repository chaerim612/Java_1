...
public class BusDAO {
	...
	"5점\t<이정용>\t감동적 입니다. 쥬륵..\n"));
			...
			//영화2
			list.add(new Bus("카카오", 10000, 5, "나는 너를 사랑해!너도 나를 사랑하니? "
	...
	"5점\t<김현진>\t피아노 배틀장면이 인상적이었습니다...☆\n"));
			...
			//영화3
			list.add(new Bus("마이크로소프트", 10000, 4, 
	...
	"4점\t<양현정>\t앤드류가필드 존잘존멋 9ㅅ9\n"));
		...
		//이름으로 영화 정보를 찾는 메서드
		public Bus searchBus(String name) {
		...
		public void addReserveInfo(MyBus e){
			reserveList.add( new MyBus( e.getmName(),e.getTime(),e.getSeat() ) );
		}
